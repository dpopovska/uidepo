    ...
    <div class="ls-user-tile">
        ...
        <div class="ls-ut-name-actions">
            ...
            <ul>
                ...
                <li>
                    <a class="ls-logout-action transition-fast" title="Log Out" href="{{ route('logout') }}"></a>
                </li>
            </ul>
        </div>
        ...
        <div class="ls-notifications-dropdown">
            ...
            <ul class="ls-nd-tiles">
                ...
                <!-- No notifications tile -->
                <li>
                    <img src="{{ asset('images/kate-dijana.png') }}" alt="">
                ...
                @admin
                    <li>
                        ...
                        <ul class="ls-nav-dropdown">
                            <li>
                                <a class="do-link list-users" href="{{ route('users.index') }}">List of all users</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="ls-nav-dropdown">
                            <li><a class="do-link about-page" href="javascript:;">About page</a></li>
                            <li><a class="do-link design" href="{{ route('designs.index') }}">Designs</a></li>
                            <li><a class="do-link subscriptions" href="{{ route('subscriptions') }}">Subscriptions</a></li>
                        </ul>
                        <!-- left sidebar navigation dropdown -->
                    </li>
                @endadmin
