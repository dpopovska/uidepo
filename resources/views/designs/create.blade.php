...
<div class="content-wrapper">
	...
	<div class="main-content-wrapper">
		...
		<div class="mc-titlebar">
			<span class="mc-title control-panel">Add new design</span>
	    </div>
					...
					<div class="widget red">
						...
						<div class="widget-content-wrapper">
							<div class="widget-content">
								{!! Form::open(['url' => route('designs.store'), 'method' => 'POST', 'class' => 'default-form', 'files' => true]) !!}
									@include('designs.form', ['buttonName' => 'Create'])
								{!! Form::close() !!}
							</div>
						</div>
						<!-- Widget main content -->
